...
function summaryRow(summary: EvaluationSummary): string {
  return [
    ...
    `${summary.rateLimitRecoveredCases}/${summary.rateLimitCooldownCases}`,
    `${summary.repairSuccessfulCases}/${summary.repairTriggeredCases}`,
...
function caseRow(result: EvaluationCaseResult): string {
  return [
    ...
    String(result.repairAttempts),
    String(result.rateLimitCooldowns),
